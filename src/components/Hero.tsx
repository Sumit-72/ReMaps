  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <img
        ...
        className="absolute inset-0 w-full h-full object-cover brightness-70 hidden md:block"
        loading="eager"
        fetchPriority="high"
      />
      <img
        ...
        className="absolute inset-0 w-full h-full object-cover brightness-70 md:hidden"
        loading="eager"
        fetchPriority="high"
      />
