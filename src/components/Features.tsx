    ...
    <div className="py-16 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg transition-all hover:shadow-lg">
            <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center text-blue-500 dark:text-blue-300 mb-4">
              <MapPin className="h-6 w-6" />
            </div>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Interactive Campus Map</h3>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg transition-all hover:shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Smart Search Functionality</h3>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg transition-all hover:shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Detailed Location Information</h3>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg transition-all hover:shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Operating Hours</h3>
            <p className="text-gray-600 dark:text-gray-300">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg transition-all hover:shadow-lg">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Always Up-to-Date</h3>
            <p className="text-gray-600 dark:text-gray-300">
